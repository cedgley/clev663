...
# Include dirs
INCLUDE_DIR:=-I$(CURDIR)/include -I$(CURDIR)/NXP-Reader-Lib/intfs -I$(CURDIR)/NXP-Reader-Lib/types -I$(CURDIR)/NXP-Reader-Lib/comps/phalMfc/src/Sw -I$(CURDIR)/NXP-Reader-Lib/comps/phalMfdf/src/ -I$(CURDIR)/NXP-Reader-Lib/comps/phpalI14443p4/src/Sw/ -I$(CURDIR)/NXP-Reader-Lib/comps/phbalReg/src/Stub/ -I$(CURDIR)/NXP-Reader-Lib/comps/phalMful/src/Sw/ -I$(CURDIR)/NXP-Reader-Lib/comps/phpalI18092mT/src/Sw/ -I$(CURDIR)/NXP-Reader-Lib/comps/phalT1T/src/
