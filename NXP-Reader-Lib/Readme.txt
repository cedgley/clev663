...
5. Revision History
V3.010_R3:
* This package contains the NFC Reader version 3.010.01.001447
* Fix for Sector select command in MIFARE UL AL
* Tag Operation: Updates for Type2 Tag with multiple sectors
